...
public class Server {
    ...
    public static Observable<Response<ConjugationNamesQuery.Data>> doConjugationNamesQuery() {
        ApolloQueryCall<ConjugationNamesQuery.Data> call = CustomApplication.getApolloClient()
    ...
    public static Observable<Response<StemQuery.Data>> doStemQuery(String term) {
        StemQuery query = StemQuery.builder()
                .term(term)
                .build();

        ApolloQueryCall<StemQuery.Data> call = CustomApplication.getApolloClient()
                .query(query);
